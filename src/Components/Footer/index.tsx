        ...
        <div className='w-full bg-black text-white/90  md:p-10 p-5 md:pb-2 pb-20 font-titillium'>
            <div className='md:flex'>
                ...
                <div className='md:w-1/5 border-r-2 border-gray-300 px-5'>
                    ...
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Services</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Tools</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Courier</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Two Wheelers</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Three Wheelers</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Mini Trucks</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Trucks</p>
                </div>
                <div className='md:w-1/5 border-r-2 border-gray-300 px-5'>
                    <h1 className='md:text-xl text-2xl text-white font-bold'>
                        Support
                    ...
                    >Contact Us</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none' onClick={() => navigate("/privacy_policy")}>Privacy Policy</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none' onClick={() => navigate("/terms_of_service")}>Terms of Services</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Driver Partner Terms & Conditions</p>
                    <p className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Zero Tolerance Policy</p>
                    <Link to="/insurance_FAQS" className='my-5 text-gray-200 hover:text-white cursor-pointer select-none'>Insurance FAQs</Link>
                </div>
