      ...
      {Object.keys(selector).length !== 0 ? (
        <div className="min-h-screen font-titillium">
          <div className="h-screen">
            <div className="relative h-[80%]">
              <img
                ...
                // src={
                //   "https://plus.unsplash.com/premium_photo-1661342486992-2a08d4b466ef?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZGVsaXZlcnl8ZW58MHx8MHx8fDA%3D"
                // }
                style={{
              ...
              <div className="absolute inset-0 flex md:items-center md:justify-center justify-center md:mt-auto mt-10 md:h-auto h-fit">
                <Add_vehicle_form setModalVisiable={setModalVisiable} />
              </div>
              <Add_vehicle />
            </div>
          </div>
          <div>
            <Advantage
              data={
                data ? { Porter_advantage: data.porter_advantage } : undefined
              }
            />
          </div>
          <div>
            <MakeLifeEasy
              data={
                data
                  ? {
                      making_life_easy_description:
                        data.making_life_easy_description,
          ...
          <div>
            <MultipleVehicles
              data={
                data
                  ? {
                      own_multiple_vehicle_image:
                        data.own_multiple_vehicle_image
                    }
                  : undefined
              }
            />
