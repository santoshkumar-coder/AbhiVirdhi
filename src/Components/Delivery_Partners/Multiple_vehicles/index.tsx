...
const MultipleVehicles: React.FC<MakeLifeEasyProps> = ({ data }) => {
  ...
  return (
    <div className="md:p-10 p-5">
      <h1 className="text-center font-bold text-2xl md:p-10 py-10">
        ...
        <div className="text-justify md:flex w-full items-center gap-10 shadow-[0_4px_8px_rgba(0,0,0,0.2),0_-4px_8px_rgba(0,0,0,0.2)] p-4 rounded-xl">
          ...
          <div className="md:w-[50%] md:space-y-3 space-y-5">
            ...
            <p className="text-gray-700 ">
              ...
              efficiency can be a huge challenge. Partner with Abhiviridhi to
              boost your earnings and manage your vehicles easily.
            </p>
            <button
              className="px-4 py-2 font-semibold text-white bg-gradient-to-r from-blue-500 to-violet-500 rounded hover:from-blue-600 hover:to-violet-600"
