...
const TransportCities: React.FC = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center bg-black/70 text-white py-5 md:px-0 px-5'>
            ...
            <div className='flex flex-wrap md:w-[60%]  justify-center items-center mt-10 gap-5'>
                {data?.map((item, index) => (
