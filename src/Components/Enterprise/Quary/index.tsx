...
import { quaryNumbers } from "../../../api_fetch/enterprices";
...
const Quary = () => {
  const [quary, setQuary] = useState<quary | null>(null);
      ...
      <div className="md:flex items-center gap-5 jusitfy-center md:w-[80%] bg-gray-200 py-5 rounded-xl px-5">
        ...
        <div className="md:w-[60%] ">
          <p className="text-justify  mt-2 text-gray-700 ">
            Reach us out on
            <Link
              className="text-blue-700 hover:text-blue-400 font-bold cursor-pointer"
              to="tel:9667309777"
            >
              {" "}
              {quary?.number}
