        ...
        <div className='my-10'>
            ...
            <div className='text-white ml-10 mr-10 py-10 flex gap-5 overflow-x-auto scrollbar-thin'>
                <div className="w-full py-8">
                    ...
                    >
                        {data?.map((item, index) => {
                            return <div key={index} className='relative ml-10 pt-1 cursor-pointer bg-gradient-to-r from-[rgba(148,4,4,1)] via-[rgba(150,126,173,1)] to-[rgba(159,6,102,1)] rounded-3xl h-[16rem]'>
                                <h3 className='text-xs rounded-lt-3xl bg-[rgba(255,192,203,0.3)] font-semibold w-fit py-1 pl-7 pr-4 rounded-r-full mt-5'>{item.service_name}</h3>
