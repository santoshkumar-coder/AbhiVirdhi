        ...
        <div className='flex flex-col items-center justify-center font-titillium md:px-auto px-7'>
            ...
            <div className='mt-10 space-y-5'>
                <div className='bg-white px-7 rounded-lg py-2'>
                    ...
                    <p className='text-gray-800 text-justify'>Enjoy on-demand pickup and delivery services at your location</p>
                </div>
                <div className='bg-white px-7 rounded-lg py-2'>
                    <h1 className='font-semibold text-lg text-justify'>Get Quick Deliveries</h1>
                    <p>Get your documents, lunch boxes, forgotten keys or other small items picked up and delivered efficiently</p>
                </div>
                <div className='bg-white px-7 rounded-lg py-2'>
                    <h1 className='font-semibold text-lg text-justify'>Get Anything Delivered</h1>
